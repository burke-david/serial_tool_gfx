...
#define UI_THEME_COLOR_BUTTONCOLOR 0

#define UI_THEME_DEFAULT 0

#define UI_THEME_BUTTONS 1

extern const ui_theme_variable_t _ui_theme_color_ButtonColor[2];
extern const ui_theme_variable_t _ui_theme_alpha_ButtonColor[2];
